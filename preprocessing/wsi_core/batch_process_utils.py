...
def initialize_df(slides, seg_params, filter_params, vis_params, patch_params, 
	...
	default_df_dict.update({
		...
		# seg params
		'seg_level': np.full((total), int(seg_params['seg_level']), dtype=np.int),
		'window_avg': np.full((total), int(seg_params['window_avg']), dtype=np.int),
		'window_eng': np.full((total), int(seg_params['window_eng']), dtype=np.int),
		'thresh': np.full((total), int(seg_params['thresh']), dtype=np.int),
